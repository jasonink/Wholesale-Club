...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        TableTitle->setGeometry(QRect(380, 50, 231, 16));
...
#ifndef QT_NO_TOOLTIP
        groupBox_3->setToolTip(QApplication::translate("MainWindow", "Select which member type you would like to view in reports", 0));
#endif // QT_NO_TOOLTIP
