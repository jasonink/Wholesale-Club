...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddMemberWindow_t, stringdata) + ofs \
...
const QMetaObject AddMemberWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddMemberWindow.data,
      qt_meta_data_AddMemberWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddMemberWindow.stringdata))
        return static_cast<void*>(const_cast< AddMemberWindow*>(this));
